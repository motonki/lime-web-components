...
export { StateService } from './src/interfaces/service/state-service.interface';
export { TranslateService } from './src/interfaces/service/translate-service.interface';

export { Connect } from './src/decorators/connect';