...
Once a web component has been created, the dev environment can be started by going to the `<plugin_module>/frontend` directory inside the plugin and running:
